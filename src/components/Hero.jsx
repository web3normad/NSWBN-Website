...
const Hero = () => {
  ...
  return (
    ...
    <div className="flex flex-col md:flex-row items-center justify-between mt-24 w-full h-screen z-auto bg-blue-50 scroll-smooth overflow-y-hidden md:overflow-y-hidden  px-5 hover:overflow-y-auto custom-scrollbar">
