    ...
    <div className="px-6 py-32 sm:px-8 md:px-16 lg:px-24">
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
          <h3 className="text-lg font-bold text-primary-100 mb-4">International Partners</h3>
        ...
        <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
          <h3 className="text-lg font-bold text-primary-100 mb-4">Government Agencies</h3>
          <ul className="list-disc pl-6 space-y-2 text-gray-700">
